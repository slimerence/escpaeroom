                        ...
                        <div class="col-lg-6">
                            <form role="form" action="{{ url('admin/reservations/update').'/'.$reservation->id }}" method="post" id="UpdateForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="book-group" name="reservation[participants]" class="form-control validate book-input" min="4" max="16" required value="{{$reservation->participants}}">
                                </div>
